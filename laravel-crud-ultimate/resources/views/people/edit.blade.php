...
<div class="container">
    <h3>Edit User</h3>
    <form action="/people/{{ $p->id }}" method="POST">
    @csrf
    @method('PUT')
      <!-- First name -->
      <div class="mb-3">
        <label for="" class="fw-bold form-label mt-4">First name</label>
        <input id="first_name" name="first_name" type="text" value="{{ $p->first_name }}" class="form-control" tabindex="1" autofocus/>
      </div>
      <!-- Last name -->
      <div class="mb-3">
        <label for="" class="fw-bold form-label">Last name</label>
        <input id="last_name" name="last_name" type="text" value="{{ $p->last_name }}" class="form-control" tabindex="2"/>
      </div>
      <!-- Age -->
      <div class="mb-3">
        <label for="" class="fw-bold form-label">Age</label>
        <input id="age" name="age" type="number" value="{{ $p->age }}" class="form-control" tabindex="3"/>
      </div>
      <!-- Gender -->
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input id="phone_number" name="phone_number" type="text" value="{{ $p->phone_number }}" class="form-control" tabindex="6"/>
      </div>
      <!-- Email -->
      <div class="mb-3">
        <label for="" class="fw-bold form-label">Email</label>
        <input id="email" name="email" type="text" value="{{ $p->email }}" class="form-control" tabindex="7"/>
      </div>
